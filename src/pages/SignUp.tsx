...
import { Mail, Lock, UserPlus, Globe, User } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0b0f1a]">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold">Join Zemen Scouts</h1>
          <p className="text-gray-400 text-sm">Start earning SBR for mapping your city</p>
        </div>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-[#0b0f1a] px-2 text-gray-500">Or join with</span>
          </div>
        </div>
